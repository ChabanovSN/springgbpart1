...
<div class="post_section">
    <form:form modelAttribute="article" class="add_article_form" method="POST" action="${contextPath}/articles">
        ...
        <p><form:label path="name" class="add_title">${labelTitle}*</form:label><form:input type="text" path="name" class="add_title_input"  />
        <p><form:errors path="name" cssClass="error" />
        ...
        <div class="author_add">
            ...
            <form:input path="company.name"  type="text" placeholder="${labelFirstName}" class="add_author_firstname" />
